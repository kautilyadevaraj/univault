...
export default function UploadPage() {
  ...
  const generateDescription = () => {
    ...
    if (formData.resourceType) {
      parts.push(formData.resourceType);
    }

    if (formData.courseName) {
      parts.push(`for ${formData.courseName}`);
    }

    if (formData.courseCode) {
      parts.push(`(${formData.courseCode})`);
    }

    if (formData.program) {
      parts.push(`- ${formData.program}`);
    }

    if (formData.courseYear) {
      parts.push(`${formData.courseYear}`);
    }

    if (formData.yearOfCreation) {
      parts.push(`| ${formData.yearOfCreation}`);
    }
  ...
  const handleLinkRequest = (requestId: string) => {
    ...
    setFormData((prev) => ({
      ...
      courseYear: `${selectedRequest.courseYear}th Year`,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.courseCode) payload.append("courseCode", formData.courseCode);
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            setAutoGenerateDesc(checked as boolean);
                            if (!checked) {
                              setFormData((prev) => ({
                                ...prev,
                                description: "",
                    ...
                    <Textarea
                      ...
                      placeholder={
                        autoGenerateDesc
                          ? "Description will be auto-generated from your selections below..."
                      ...
                      onChange={(e) => {
                        ...
                        if (autoGenerateDesc) {
                          setAutoGenerateDesc(false);
                        }
                      }}
                      rows={2}
                      disabled={autoGenerateDesc}
                      className={
                        autoGenerateDesc ? "bg-muted text-muted-foreground" : ""
                      }
                    />
                    {autoGenerateDesc && formData.description && (
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      {formData.school === "SoCSE" ? (
                        ...
                        <Input
                          placeholder="Enter your program (e.g., MBA, LLB)"
                          value={formData.program}
                          onChange={(e) =>
                            setFormData((prev) => ({
                              ...prev,
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="courseCode"
                        placeholder="e.g., CS101, ENG202 (optional)"
