...
export default function Theme() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className={`dark:bg-zinc-900 bg-zinc-100 dark:text-primary-color text-zinc-500 border dark:border-zinc-800 border-zinc-200 rounded-full p-2 duration-300 transition-transform group: ${
